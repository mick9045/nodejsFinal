    ...
    <div class="form-group px-4 py-4">
        <form onsubmit="{ function(e) {e.preventDefault()} }">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control mr-2" placeholder="product name" id="name" name="productName">
                <div class="input-group-prepend">
                    <span class="input-group-text">Price</span>
                </div>
                <input type="number" class="form-control" placeholder="0" id="price" name="productPrice">
            </div>
            <div class="form-group">
                <label for='customFile'>Image:</label>
                <div class="custom-file mb-3">
                    <input type="file" class="custom-file-input" id="customFile" accept=".jpg, .jpeg, .png" name = "productImage">
                    <label class="custom-file-label" for="customFile">Choose file</label>
                </div>
            </div>
            <div class="form-group">
              <label for="comment">Defenition:</label>
              <textarea class="form-control" rows="5" id="comment" name="productDefenition"></textarea>
            </div>
